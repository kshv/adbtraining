...
val configs = Map(
  ...
  "fs.azure.account.oauth2.client.id" -> "4d912675-5d9f-4f41-a7e8-73ce0ada920f",
...
// COMMAND ----------
  ...
  dbutils.fs.mount(
  source = "abfss://data@laketraining.dfs.core.windows.net/",
  mountPoint = "/mnt/data",
...
object SentimentDetector extends Serializable {
    val accessKey = "f63a1e78a17a40d6817b941fa6923a21"
    val host = "https://trainingdltextanalytics.cognitiveservices.azure.com/"
